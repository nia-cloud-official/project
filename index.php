...
// Insert the input values into the database table
$sql = "INSERT INTO accounts (fullname, username, password, address, date, email, phone, gender) VALUES ('$fullname', '$username', '$password', '$address', '$date', '$email', '$phone', '$gender')";
...
.form_wrapper {
    ...
    &[type="submit"] {
		...
		transition: all 0.30s ease-in-out;
		&:hover {
			background: darken(lightgreen,7%);
		}
		&:focus {
			background: darken(lightgreen,7%);
		}
